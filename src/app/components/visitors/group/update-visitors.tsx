...
import { updateGroupSchedule } from "@/lib/serverActions/visitors/update/UpdateVisitorActions";
...
export default function UpdateGroupVisitors({ scheduleData, scheduleID }:any) {
  ...
  const form = useForm({
    ...
    defaultValues: {
      ...
      // Initialize visitors with existing data
      visitors: data.visitiors || [], // Make sure this is populated from scheduleData
    },
  });
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    try {
      ...
      if (updateVisitorResponse.code === 200) {
